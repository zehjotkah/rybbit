...
export function FreeTrialBanner() {
  ...
  if (!subscription.isTrial) {
    ...
    return (
      <div className="px-4 py-3 border-b border-blue-100 dark:border-blue-800/30 bg-blue-50/80 dark:bg-blue-900/20 text-sm flex justify-between items-center mb-4">
