...
**Want to see another example of great open-source software?** Check out [Rybbit Analytics](https://rybbit.io)—privacy-focused, lightweight web analytics that respects your users. [Try it free](https://app.rybbit.io/signup) or [explore our demo](https://demo.rybbit.io/21).
