  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>
          Our database servers are not accessible on the open internet. They are protected behind private networks with
          strict firewall rules, ensuring that only authorized application servers can access them. This significantly
          reduces the attack surface and protects your data from external threats.
        </p>
        ...
        <p>
          We never store your payment details. All payment processing is handled by PCI DSS compliant payment processors
          (Stripe). Your credit card information goes directly to the payment processor and never touches our servers.
        </p>
