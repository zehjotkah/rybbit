...
export default function IndexPage() {
  return (
    <div className="flex flex-col items-center justify-center overflow-x-hidden">
      ...
      <h2 className="text-lg md:text-2xl pt-6 md:pt-8 px-4 tracking-tight max-w-3xl text-center text-neutral-300">Open source web + product analytics for everyone</h2>
      ...
      <div className="flex flex-col sm:flex-row my-8 md:my-10 items-center justify-center gap-4 md:gap-6 text-base md:text-lg px-4">
        <Link href="https://tracking.tomato.gg/signup" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-500 text-white font-medium px-6 py-3.5 rounded-lg shadow-lg shadow-emerald-900/20 transform hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50">
            Track your Site
          </button>
        </Link>
        <Link href="https://tracking.tomato.gg/1" className="w-full sm:w-auto">
          <button className="w-full sm:w-auto bg-neutral-800 hover:bg-neutral-700 text-white font-medium px-6 py-3.5 rounded-lg border border-neutral-600 transform hover:-translate-y-0.5 transition-all duration-200 hover:border-neutral-400 focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-opacity-50">
            View Live Demo
          </button>
        </Link>
      </div>
      ...
      <div className="relative w-full max-w-[1300px] mb-10 px-4">
        ...
        <div className="relative z-10 rounded-xl overflow-hidden border-2 border-neutral-700 shadow-2xl shadow-emerald-900/10">
