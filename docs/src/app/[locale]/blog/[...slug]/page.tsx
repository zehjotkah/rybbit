    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-16">
        ...
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">{page.data.title}</h1>

          {page.data.description && <p className="text-xl text-neutral-400 mb-6">{page.data.description}</p>}
