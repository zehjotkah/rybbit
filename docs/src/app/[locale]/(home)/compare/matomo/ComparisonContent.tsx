  ...
  return (
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Simplicity Wins Over Complexity</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Modern Technology vs Legacy Architecture</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Privacy by Default, Not by Configuration</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Zero Maintenance vs Constant Updates</h3>
        <p className="leading-relaxed">
          ...
          servers to manage, no updates to install, no security patches to worry about. Your analytics just work, always
          up-to-date with the latest features and security improvements. Focus on your business, not on maintaining
          analytics infrastructure.
        </p>
      </div>

      <div className="space-y-4">
        <h3 className="text-xl font-medium">Features That Actually Matter</h3>
        <p className="leading-relaxed">
          ...
          conversions, error tracking to catch issues, and beautiful visualizations that make data exploration
          enjoyable. We don't just match Matomo's capabilities; we provide the modern features that today's businesses
          actually need.
        </p>
      </div>

      <div className="space-y-4">
        <h3 className="text-xl font-medium">Affordable Cloud vs Expensive Self-Hosting</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Built for Today's Web</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Try It Before You Commit</h3>
        <p className="leading-relaxed">
          Setting up Matomo requires significant time investment before you can even see if it meets your needs. You
          need to provision servers, install dependencies, configure the database, set up tracking, and navigate through
