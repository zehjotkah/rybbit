  ...
  return (
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">PostHog Is Amazing... For Developers</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Beautiful Simplicity vs Feature Overload</h3>
        <p className="leading-relaxed">
          ...
          tools are this beautiful, your team will actually use them.
        </p>
      </div>

      <div className="space-y-4">
        <h3 className="text-xl font-medium">Privacy-First vs Privacy-Optional</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Predictable Pricing vs Billing Surprise</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Team-Friendly vs Developer-Only</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Bootstrapped Focus vs VC Pressure</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">The Verdict: Choose Your Fighter</h3>
        <p className="leading-relaxed">
