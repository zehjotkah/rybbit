  ...
  return (
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Free Isn't Always Better</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">See 100% of Your Traffic, Not Just a Sample</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Essential Features You Actually Need</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Keep Your Data Forever, Export Anytime</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">No CDN Lock-in Required</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Advanced Features for Modern Teams</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Open Source with Self-Hosting Option</h3>
        <p className="leading-relaxed">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-medium">Analytics Is Our Only Focus</h3>
        <p className="leading-relaxed">
