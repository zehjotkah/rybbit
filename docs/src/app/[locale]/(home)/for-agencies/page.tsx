...
export const metadata = createMetadata({
  ...
  openGraph: {
    ...
    images: [
      createOGImageUrl(
        "Rybbit for Agencies",
        "Every client site in one workspace, on dashboards clients can actually read.",
        "Solutions"
      ),
    ],
  },
...
export default function ForAgenciesPage() {
  return (
    <div className="overflow-x-clip">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                ...
                explain it. Rybbit puts sessions, sources, and conversions on one screen that stays legible to someone
                who looks at it once a month.
              </p>
            </div>
          </div>
          <div className="border-t border-neutral-200 px-5 py-10 dark:border-neutral-800 sm:px-8 lg:px-10">
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
              <p className="max-w-lg text-base leading-7 text-neutral-600 dark:text-neutral-400">
                The hidden cost of GA4 on a client roster is the explaining, not the price. Every report needs a
                translation layer, every dashboard needs a walkthrough, and every walkthrough is unbilled time. An
                analytics tool a client can read on their own takes the walkthrough off the calendar.
              </p>
              <p className="max-w-lg text-base leading-7 text-neutral-600 dark:text-neutral-400">
                There&apos;s a compliance angle too. Every GA-instrumented site you hand over ships with a cookie banner
                and a consent-declined blind spot in its numbers. Rybbit is cookieless, so the sites you build need
                neither, and the traffic you report is the traffic that actually happened.{" "}
                <Link
      ...
      >
        <div className="relative mx-auto max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                Onboarding a client onto analytics shouldn&apos;t be a project with a kickoff meeting. This is the whole
                workflow. Most of it is done before the coffee goes cold.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-px bg-neutral-200 dark:bg-neutral-800 lg:grid-cols-12">
            <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-7 lg:px-10">
              ...
              <p className="mt-2 max-w-lg text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                Organizations group your team and client sites together, with member roles for who can view and who can
                manage. Jump between client dashboards without logging in and out.
              </p>
            ...
            <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-5 lg:px-10">
              ...
              <p className="mt-2 max-w-md text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                Teams group sites and the people responsible for them. Set up a team per client, or per retainer tier,
                and access follows the roster instead of being managed site by site.
              </p>
            ...
            <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-7 lg:px-10">
              ...
              <p className="mt-2 max-w-lg text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                ...
                embedded straight into your own client portal. Clients see their site&apos;s numbers without creating an
                account, and never anyone else&apos;s.{" "}
                <Link
            ...
            <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-7 lg:px-10">
              ...
              <p className="mt-2 max-w-lg text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                Rybbit is cookieless and compliant with GDPR and CCPA out of the box, so the sites you build don&apos;t
                need a consent banner for analytics. One less awkward conversation per launch, and no consent-declined
                gap in the numbers you report.
              </p>
      ...
      <section className="border-b border-neutral-200 dark:border-neutral-800" aria-labelledby="agency-migration-title">
        <div className="relative mx-auto max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800">
          <GridCrosses />
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="relative border-b border-neutral-200 bg-plate-accent px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-7 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
          ...
          <div className="border-t border-neutral-200 px-5 py-10 dark:border-neutral-800 sm:px-8 lg:px-10">
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
              <p className="max-w-lg text-base leading-7 text-neutral-600 dark:text-neutral-400">
                Clients coming from{" "}
                <span className="font-medium text-neutral-800 dark:text-neutral-200">Plausible</span>,{" "}
                <span className="font-medium text-neutral-800 dark:text-neutral-200">Umami</span>, or{" "}
                <span className="font-medium text-neutral-800 dark:text-neutral-200">Simple Analytics</span> bring their
                data with them: up to 36 months of history on Standard, 60 months on Pro, and no limits if you
              ...
              <p className="max-w-lg text-base leading-7 text-neutral-600 dark:text-neutral-400">
                Moving clients off Google Analytics? GA4 history can&apos;t be imported (no tool maps its event model
                honestly), so those clients start fresh with numbers they can finally read. The comparison pages cover
                how the metrics line up, and answer &ldquo;why don&apos;t these match GA?&rdquo; before a client asks:{" "}
                <Link
                  href="/compare/google-analytics"
                  className="font-medium text-emerald-700 transition-colors duration-200 hover:text-emerald-600 dark:text-emerald-400 dark:hover:text-emerald-300"
                >
      ...
      <section className="border-b border-neutral-200 dark:border-neutral-800" aria-labelledby="agency-pricing-title">
        <div className="relative mx-auto max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800">
          ...
          <div className="grid grid-cols-1 border-b border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                No per-site packs, no per-seat surprises. One subscription covers the whole roster, priced by traffic.
                Referrals pay 50% through the affiliate program.
              </p>
            </div>
          </div>
          <div>
      ...
      <div id="agency-faq" className="scroll-mt-24">
        <PersonaFaqSection heading="Agency FAQ" items={faqItems} />
      </div>
