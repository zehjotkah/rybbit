...
**Rybbit** is a powerful open source web and products analytics platform. Check out our [live demo](https://demo.rybbit.io/21) using a real production site that sends over **15,000,000** events a month.
