...
**Rybbit** is an open source web and products analytics platform. Check out our [live demo](https://demo.rybbit.io) using a real production site that sends over **10,000,000** events a month.
