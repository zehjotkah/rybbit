...
| `trackWebVitals`      | `boolean`          | `true`  | Track website performance metrics.                                                                                                                                      |
...
- **`properties`** (`object`, Optional): An object containing additional key-value pairs related to the event.
