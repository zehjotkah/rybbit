...
```html
<script src="https://app.rybbit.com/api/script.js" async data-site-id="YOUR_SITE_ID"></script>
```
If you are self-hosting Rybbit `app.rybbit.com` will be domain of your Rybbit instance.
