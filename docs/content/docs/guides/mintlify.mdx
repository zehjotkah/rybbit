...
Navigate to your Rybbit dashboard to obtain your **Site ID**. The script source will be `https://app.rybbit.com/api/script.js` (or your self-hosted URL if applicable).
</Step>
...
(function() {
  ...
  script.src = 'https://app.rybbit.com/api/script.js';
  script.async = true;
  script.defer = true;
...
If you're self-hosting Rybbit, replace `https://app.rybbit.com/api/script.js` with your self-hosted URL (e.g., `https://your-domain.com/api/script.js`).
</Step>
