...
- Replace `YOUR_SITE_ID` with your actual Site ID. The script source `https://app.rybbit.com/api/script.js` is for the standard cloud-hosted Rybbit instance.
</Step>
</Steps>
...
{% if jekyll.environment == "production" and site.rybbit_site_id %}
  <script async defer src="{{ site.rybbit_instance_url | default: 'https://app.rybbit.com' }}/api/script.js" data-site-id="{{ site.rybbit_site_id }}"></script>
{% endif %}
{% endraw %}
```
</Step>
...
rybbit_instance_url: "https://app.rybbit.com" # Optional, defaults in include
