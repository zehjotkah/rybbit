...
- Go to **Settings** (bottom left in Admin).
- Click on **Checkout** (or **Checkout and accounts** depending on your Admin version).

**2. Add the Script:**
- Scroll down to the **Order status page** section.
- In the **Additional scripts** box, paste the following:
