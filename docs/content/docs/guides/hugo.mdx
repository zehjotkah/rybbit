...
- Replace `https://app.rybbit.com` and `YOUR_SITE_ID` with your actual details.
</Step>
...
{{ if and (not .Site.IsServer) .Site.Params.rybbitSiteID }}
  <script async defer src="{{ .Site.Params.rybbitInstanceURL | default "https://app.rybbit.com" }}/api/script.js" data-site-id="{{ .Site.Params.rybbitSiteID }}"></script>
{{ end }}
```
</Step>
...
```toml
[params]
  rybbitInstanceURL = "https://app.rybbit.com" # Your Rybbit instance URL
