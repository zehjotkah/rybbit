...
Deletes a team. Requires admin/owner role.
...
<TypeTable
  type={{
    success: {
      description: 'Whether the team was deleted',
      type: 'boolean',
    },
  }}
/>
...
<Tabs items={['cURL', 'JavaScript', 'Python', 'PHP', 'Ruby', 'Go', 'Rust', 'Java', '.NET']}>
  <Tab value="cURL">
```bash title="Request"
curl -X DELETE "https://app.rybbit.io/api/organizations/org_abc123/teams/team_xyz789" \
...
```
  ...
  <Tab value="Go">
```go title="Request"
req, _ := http.NewRequest("DELETE", "https://app.rybbit.io/api/organizations/org_abc123/teams/team_xyz789", nil)
...
let res = client
    .delete("https://app.rybbit.io/api/organizations/org_abc123/teams/team_xyz789")
...
var response = await client.DeleteAsync("https://app.rybbit.io/api/organizations/org_abc123/teams/team_xyz789");
