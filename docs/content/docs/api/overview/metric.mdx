...
<TypeTable
  type={{
    ...
    count: {
      description: 'Number of unique sessions for this value. For parameter=event_name, this is the total number of event occurrences instead',
      type: 'number',
    },
    percentage: {
    ...
    pageviews_percentage: {
      description: 'Share of total pageviews (for page-related parameters)',
      type: 'number',
      typeDescription: 'Range: 0-100',
      required: false,
    },
