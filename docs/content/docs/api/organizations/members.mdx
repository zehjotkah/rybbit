...
<TypeTable
  type={{
    ...
    siteAccess: {
      description: "The member's site-access restrictions within the organization",
      type: 'object',
    },
    teams: {
      description: 'Teams the member belongs to',
      type: 'array',
    },
  }}
/>
...
<TypeTable
  type={{
    hasRestrictedSiteAccess: {
      description: 'Whether the member is restricted to specific sites',
      type: 'boolean',
    },
    siteIds: {
      description: 'IDs of the sites the member can access (empty when access is not restricted)',
      type: 'array',
    },
  }}
/>
