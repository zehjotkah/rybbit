...
<TypeTable
  type={{
    type: {
      ...
      type: 'string',
      typeDescription: '"page" | "event" | "outbound" | "button_click" | "form_submit" | "copy"',
      required: true,
    },
    value: {
...
<TypeTable
  type={{
    ...
    visitors: {
      description: 'Deprecated alias of `sessions`, kept for backwards compatibility',
      type: 'number',
    },
    conversion_rate: {
      description: 'Percentage of step 1 sessions that reached this step',
      type: 'number',
