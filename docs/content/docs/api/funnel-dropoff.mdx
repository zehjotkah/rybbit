...
async function analyzeFunnel() {
  ...
  return data; // array of { step_number, step_name, sessions, conversion_rate, dropoff_rate }
}
```
</Tab>
<Tab value="Python">
...
{
  "data": [
    { "step_number": 1, "step_name": "Homepage", "sessions": 10000, "conversion_rate": 100,  "dropoff_rate": 0 },
    { "step_number": 2, "step_name": "Pricing",  "sessions": 4500,  "conversion_rate": 45,   "dropoff_rate": 55 },
    { "step_number": 3, "step_name": "Signup",   "sessions": 1800,  "conversion_rate": 18,   "dropoff_rate": 60 },
    { "step_number": 4, "step_name": "Complete", "sessions": 1080,  "conversion_rate": 10.8, "dropoff_rate": 40 }
  ]
}
```
...
The leak isn't always the step with the fewest sessions — it's the step with the steepest **drop-off**. Pick the maximum `dropoff_rate`.
