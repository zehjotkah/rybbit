...
<Callout type="warn">
Adding custom code requires a **Carrd Pro** subscription (Pro Standard or Pro Plus). The custom-code Embeds feature is not included on Pro Lite.
</Callout>
...
If your Carrd site has multiple pages (Pro Plus feature), the tracking script in the head code will automatically load on all pages.
